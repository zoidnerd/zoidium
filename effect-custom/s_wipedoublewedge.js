// S_WipeDoubleWedge (AlipFX) - Zoidium custom effect
// Source: S_WipeDoubleWedge (AlipFX).txt
// Reference shader: assets/shaders/fragment/preset/s_wipedoublewedge.glsl

(this.defaultName = "S WipeDoubleWedge"),
  (this._zoidiumMeta = {
    category: "AlipFX",
    desc: "Wipe transition via two opposing wedges meeting at center.",
  }),
  (this.shaderfile = "preset/s_wipedoublewedge"),
  ...
  (this.propertyDefinitions = {
    ...
    Wipe_Direction: { dynamic: !0, name: "Wipe Direction", type: PZ.property.type.OPTION, value: 0, step: 1, items: "Normal;Reverse" },
    ...
    Pointiness: { dynamic: !0, name: "Pointiness", type: PZ.property.type.NUMBER, value: 2, step: 0.1 },
