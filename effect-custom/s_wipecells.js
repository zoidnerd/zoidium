// S_WipeCells (AlipFX) - Zoidium custom effect
// Source: S_WipeCells (AlipFX).txt
// Reference shader: assets/shaders/fragment/preset/s_wipecells.glsl

(this.defaultName = "S WipeCells"),
  (this._zoidiumMeta = {
    category: "AlipFX",
    desc: "Voronoi-cell wipe that grows or shrinks from each cell.",
  }),
  (this.shaderfile = "preset/s_wipecells"),
  ...
  (this.propertyDefinitions = {
    ...
    Auto_Trans: { dynamic: !0, name: "Auto Trans", type: PZ.property.type.OPTION, value: 0, items: "use Wipe%;use time (0..1)" },
    Wipe_Percent: { dynamic: !0, name: "Wipe Percent", type: PZ.property.type.NUMBER, value: 0, step: 0.1 },
    Cells: { dynamic: !0, name: "Cells", type: PZ.property.type.OPTION, value: 1, items: "Shrink;Grow" },
    Edge_Softness: { dynamic: !0, name: "Edge Softness", type: PZ.property.type.NUMBER, value: 0, step: 0.1 },
    Frequency: { dynamic: !0, name: "Frequency", type: PZ.property.type.NUMBER, value: 6, step: 0.1 },
    Rel_Width: { dynamic: !0, name: "Rel Width", type: PZ.property.type.NUMBER, value: 1, step: 0.1 },
    Seed: { dynamic: !0, name: "Seed", type: PZ.property.type.NUMBER, value: 0.43, step: 0.1 },
  ...
  (this.load = async function (e) {
    ...
    const mat = new THREE.ShaderMaterial({
      uniforms: {
        ...
        Cells: { type: "f", value: 1 },
        Edge_Softness: { type: "f", value: 0 },
        Frequency: { type: "f", value: 6 },
        Rel_Width: { type: "f", value: 1 },
        Seed: { type: "f", value: 0.43 },
  ...
  (this.update = function (e) {
    ...
    u.Cells.value = this.properties.Cells.get(e);
