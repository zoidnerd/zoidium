// S_WipeBlobs (AlipFX) - Zoidium custom effect
// Source: S_WipeBlobs (AlipFX).txt
// Reference shader: assets/shaders/fragment/preset/s_wipeblobs.glsl

(this.defaultName = "S WipeBlobs"),
  (this._zoidiumMeta = {
    category: "AlipFX",
    desc: "FBM-noise blob wipe with gradient bias and soft edges.",
  }),
  (this.shaderfile = "preset/s_wipeblobs"),
  ...
  (this.propertyDefinitions = {
    ...
    Octaves: { dynamic: !0, name: "Octaves", type: PZ.property.type.NUMBER, value: 1, step: 0.1 },
