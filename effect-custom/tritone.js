// Tritone (AlipFX) - Zoidium custom effect
// Source: Tritone (AlipFX).txt
// Reference shader: assets/shaders/fragment/preset/tritone.glsl

(this.defaultName = "Tritone"),
  (this._zoidiumMeta = {
    category: "AlipFX",
    desc: "Three-color mapping across shadow, midtone, highlight.",
  }),
  (this.shaderfile = "preset/tritone"),
