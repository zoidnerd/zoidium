// Grid (AlipFX) - Zoidium custom effect
// Source: Grid (AlipFX).txt
// Reference shader: assets/shaders/fragment/preset/grid.glsl

(this.defaultName = "Grid"),
  (this._zoidiumMeta = {
    category: "AlipFX",
    desc: "Grid pattern overlay with cell size and color.",
  }),
  (this.shaderfile = "preset/grid"),
  ...
  (this.propertyDefinitions = {
    ...
    Size_from: { dynamic: !0, name: "Size from", type: PZ.property.type.OPTION, value: 1, items: "Corner Point;Width;Width & Height" },
    Width: { dynamic: !0, name: "Width", type: PZ.property.type.NUMBER, value: 101, step: 0.1 },
    Height: { dynamic: !0, name: "Height", type: PZ.property.type.NUMBER, value: 101, step: 0.1 },
    Border: { dynamic: !0, name: "Border", type: PZ.property.type.NUMBER, value: 5, step: 0.1 },
    ...
    Invert_grid: { dynamic: !0, name: "Invert grid", type: PZ.property.type.OPTION, value: 0, items: "normal;inverted" },
    Opacity: { dynamic: !0, name: "Opacity", type: PZ.property.type.NUMBER, value: 1, step: 0.1 },
    Blending_mode: { dynamic: !0, name: "Blending mode", type: PZ.property.type.OPTION, value: 1, items: "Normal;Dissolve;Multiply;Add;Multiply;Screen;Overlay;Hard Light;Soft Light;Color Dodge;Color Burn;Darken;Lighten;Difference;Exclusion;Hue;Saturation;Color;Luminosity", step: 1 },
  }),
  ...
  (this.load = async function (e) {
    ...
    const mat = new THREE.ShaderMaterial({
      uniforms: {
        ...
        Width: { type: "f", value: 101 },
        Height: { type: "f", value: 101 },
        Border: { type: "f", value: 5 },
        Feather_Width: { type: "f", value: 1 },
        Feather_Height: { type: "f", value: 1 },
        Color: { type: "v3", value: new THREE.Vector3(0, 0, 0) },
        Invert_grid: { type: "i", value: 0 },
        Opacity: { type: "f", value: 1 },
        Blending_mode: { type: "i", value: 1 },
      },
  ...
  (this.update = function (e) {
    ...
    u.Border.value = this.properties.Border.get(e);
    ...
    u.Invert_grid.value = Math.round(this.properties.Invert_grid.get(e));
