...
// Source: Iris Wipe (AlipFX) (dull version).txt
// Reference shader: assets/shaders/fragment/preset/iris-wipe.glsl

(this.defaultName = "Iris Wipe"),
  (this._zoidiumMeta = {
    category: "AlipFX",
    desc: "Polygonal iris wipe with star points and feather.",
  }),
  (this.shaderfile = "preset/iris-wipe"),
  ...
  (this.propertyDefinitions = {
    ...
    Iris_Points: { dynamic: !0, name: "Iris Points", type: PZ.property.type.NUMBER, value: 6, step: 0.1 },
    Outer_Radius: { dynamic: !0, name: "Outer Radius", type: PZ.property.type.NUMBER, value: 0.3, step: 0.1 },
    Use_Inner_Radius: { dynamic: !0, name: "Use Inner Radius", type: PZ.property.type.OPTION, value: 1, items: "Disabled;Enabled" },
    Inner_Radius: { dynamic: !0, name: "Inner Radius", type: PZ.property.type.NUMBER, value: -0.7, step: 0.1 },
  ...
  (this.load = async function (e) {
    ...
    const mat = new THREE.ShaderMaterial({
      uniforms: {
        ...
        Iris_Points: { type: "f", value: 6 },
        Outer_Radius: { type: "f", value: 0.3 },
        Use_Inner_Radius: { type: "i", value: 1 },
        Inner_Radius: { type: "f", value: -0.7 },
